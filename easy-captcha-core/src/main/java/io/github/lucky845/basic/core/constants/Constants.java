package io.github.lucky845.basic.core.constants;
...
public class Constants {
    ...
    /**
     * 用于starter的properties配置前缀
     */
    public static final String PROJECT_BASE_PREFIX = "easy-captcha";

    /**
     * 定义验证码使用的字符，去除了0、O、I、L等容易混淆的字母
     */
     ...
     * 字符的最大索引，不包括最大值
     */
    public static final int CHAR_MAX_INDEX = CHARS.length;
